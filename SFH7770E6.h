...
/*=========================================================================
PROXIMITY INTEGRATION SETTING
-----------------------------------------------------------------------*/
typedef enum
{
	SFH7770E6_PS_INT_100US		= 0x00,
	SFH7770E6_PS_INT_200US		= 0x01,
	SFH7770E6_PS_INT_300US		= 0x02,
	SFH7770E6_PS_INT_500US		= 0x03,
	SFH7770E6_PS_INT_750US		= 0x04,
	SFH7770E6_PS_INT_1000US		= 0x05,
	SFH7770E6_PS_INT_1500US		= 0x06,
	SFH7770E6_PS_INT_2500US		= 0x07
} SFH7770E6PsIntegrationTime;
...
{
	/* this should be in the order of the registers */
	word als;
	byte status;
	byte led1;
	byte led2;
...
#if 0
/* Unified sensor driver for the OSRAM proximity sensor */
class SFH_7770_E6
{
	public:
	bool begin(void);
	...
	void setLedCurrent(byte, SFH7770E6LedCurrent);
	byte getLedCurrent(byte);
	void setPsIntegrationTime(SFH7770E6PsIntegrationTime);
	...
	int readCnt(byte address, byte reg, int count, byte *data);
};
#endif
#endif /* SFH7770E6_H_ */
